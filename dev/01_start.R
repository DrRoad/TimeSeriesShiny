...
golem::fill_desc(
  pkg_name = "TimeSeriesShiny", # The Name of the package containing the App 
  pkg_title = "Shiny for time Series", # The Title of the package containing the App 
  pkg_description = "Shiny app for importing, fitting and cross-validating time-series model", # The Description of the package containing the App 
  author_first_name = "Kasia", # Your First Name
  author_last_name = "Kulma",  # Your Last Name
  author_email = "katarzyna.kulma@gmail.com",      # Your Email
